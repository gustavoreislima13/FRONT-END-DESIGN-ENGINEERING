...
export default function EditarAgendamento({ params }: { params: { id_agendamento: number } }) {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center py-10 px-4">
            <h1 className="text-3xl md:text-4xl font-bold text-blue-400 mb-6">Editar agendamento</h1>
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md md:max-w-lg">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="idStatus" className="block text-sm font-medium mb-1">Status:</label>
                        <input
                            type="text"
                            name="status"
                            id="idStatus"
                    ...
                    <div>
                        <label htmlFor="idPlaca" className="block text-sm font-medium mb-1">Placa do Veículo:</label>
                        <input
                            type="text"
                            name="veiculos_placa"
                            id="idPlaca"
